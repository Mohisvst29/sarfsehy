...
export default function FloatingContact({ phoneNumber }: { phoneNumber: string }) {
  ...
  return (
    <div className={`fixed bottom-6 left-6 z-50 flex flex-col gap-3 transition-all duration-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0 pointer-events-none'}`}>
