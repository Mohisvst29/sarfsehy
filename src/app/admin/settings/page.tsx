    ...
    <div className="max-w-xl mx-auto pb-10">
      ...
      <form onSubmit={handleSave} className="space-y-6 bg-surface-container-lowest p-8 rounded-2xl border border-outline-variant">
        ...
        <div className="pt-6 flex justify-end">
          <button type="submit" disabled={isSaving} className="w-full bg-primary text-on-primary px-8 py-3 rounded-xl font-bold flex justify-center items-center gap-2 hover:opacity-90 disabled:opacity-50 transition-all">
